...
function DashboardTopBar({updateDashboardPeriod, updateProductAndOrder}){
        ...
        const handleDatePickerValueChange = (newValue) => {
            ...
            const updatedDate = {fromDate: newValue.startDate, toDate: newValue.endDate}
            setDateValue(newValue); 
            updateDashboardPeriod(newValue)
            updateProductAndOrder(updatedDate)
        } 
