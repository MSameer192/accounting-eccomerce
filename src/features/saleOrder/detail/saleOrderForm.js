                        ...
                        <tbody>
                            {
                                saleOrderItemObj?.map((data, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <InputTextUpdated containerStyle='max-w-xs' type="number" defaultValue={data.taxFee} updateType="taxFee" nestedObj='taxFee' nestedIndex={index} placeholder="Tax Fee" labelTitle="" updateFormValue={updateFormValue}/>
                                        </td>
                                        <td>
